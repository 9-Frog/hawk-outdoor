...
(function(){
  ...
  function updateSummary(d){
    ...
    if(mode === 'admin' && previewBox){
      ...
      const msg = [
        'Hello, thank you for your interest in Hawk Outdoor.',
        '',
        'Here is your preliminary quote based on the current specification:',
        ...
        `Preliminary price: ${fmt.format(total)} (subject to final site survey and confirmation)`,
        '',
        'If you would like to proceed, we can arrange a site visit and final quotation.'
      ].join('\n');
